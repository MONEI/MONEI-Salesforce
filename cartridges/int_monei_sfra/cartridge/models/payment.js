...
function getSelectedPaymentInstruments(selectedPaymentInstruments) {
    return collections.map(selectedPaymentInstruments, function (paymentInstrument) {
        var results = {
            ...
            paymentMethodName: PaymentMgr.getPaymentMethod(paymentInstrument.paymentMethod).getName(),
            formattedAmount: StringUtils.formatMoney(paymentInstrument.paymentTransaction.amount)
        };
