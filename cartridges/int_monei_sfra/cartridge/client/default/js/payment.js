...
function handleTabChange(e) {
    var isMoneiContentSelected = e.target.hash === '#monei-content';
...
$(document).ready(function () {
    var totalCart = document.querySelector('.grand-total-sum').innerHTML;
                ...
                success: function (data) {
                    if (data.error) {
                        ...
                        if (payment.err) {
                            ...
                            var pageType = $('input[name="moneiPageType"]').val();
                            if (pageType === 'redirect') {
                                ...
                                try {
                                    monei.confirmPayment({
                                        ...
                                        fullscreen: pageType === 'modal_page_full_screen'
